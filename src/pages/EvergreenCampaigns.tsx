...
export function EvergreenCampaigns() {
  return (
    <div>
      <section className="bg-gradient-to-br from-purple-50 to-white py-16 sm:py-24">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="bg-gradient-to-br from-purple-100 to-pink-100 p-12 rounded-2xl">
              <div className="bg-white p-8 rounded-xl shadow-lg">
                <Repeat className="text-purple-600 mb-4" size={48} />
