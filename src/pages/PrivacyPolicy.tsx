          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-10">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
                ...
                <li>Contact us at <a href="mailto:Hello@everydayworkflow.com" className="text-blue-600 hover:text-blue-700">Hello@everydayworkflow.com</a></li>
              </ul>
            ...
            <section>
              ...
              <div className="bg-gray-50 border-2 border-gray-200 rounded-lg p-6">
                ...
                <p className="text-gray-700 mt-2">
                  Phone: <a href="tel:+14804155274" className="text-blue-600 hover:text-blue-700">
                    (480) 415-5274
                  </a>
                </p>
                <p className="text-gray-700">
                  Email: <a href="mailto:Privacy@everydayworkflow.com" className="text-blue-600 hover:text-blue-700">
                    Privacy@everydayworkflow.com
                  </a>
                </p>
                <p className="text-gray-700">
                  General Inquiries: <a href="mailto:Hello@everydayworkflow.com" className="text-blue-600 hover:text-blue-700">
