        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-gray-600 mb-10 leading-relaxed">
              ...
              evergreen campaigns, and a managed SaaS platform. Stop juggling tools and start growing
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/services"
                className="bg-white text-blue-600 border-2 border-blue-600 px-8 py-4 rounded-lg hover:bg-blue-50 transition-colors font-semibold text-lg inline-flex items-center justify-center"
              >
                Explore Services
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">SaaS Platform</h3>
              <p className="text-gray-600 mb-4 leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">
                We implement AI agents, automations, and the Everyday Workflow SaaS platform.
