          ...
          <div className="prose prose-lg max-w-none">
            <div className="space-y-10">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  For questions about these Terms, contact <a href="mailto:Legal@everydayworkflow.com" className="text-blue-600 hover:text-blue-700">Legal@everydayworkflow.com</a>.
                </p>
              </div>
            </div>
          </div>
