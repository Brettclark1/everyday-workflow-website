      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="bg-gradient-to-br from-green-100 to-blue-100 p-12 rounded-2xl">
              <div className="bg-white p-8 rounded-xl shadow-lg">
                <Phone className="text-green-600 mb-4" size={48} />
          ...
          <div className="mb-20">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="bg-white border-2 border-gray-200 p-6 rounded-xl hover:border-green-500 transition-colors">
          ...
          <div className="mb-20">
            <div className="bg-gray-50 rounded-2xl p-8 md:p-12">
              <div className="flex items-start mb-8">
                <BookOpen className="text-blue-600 mr-4 flex-shrink-0" size={40} />
                <div>
