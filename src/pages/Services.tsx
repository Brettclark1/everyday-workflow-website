        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-20">
            <div className="flex items-start mb-8">
              <div className="bg-blue-600 rounded-xl p-4 mr-6">
          ...
          <div className="mb-20">
            <div className="flex items-start mb-8">
              <div className="bg-green-600 rounded-xl p-4 mr-6">
          ...
          <div className="mb-20">
            <div className="flex items-start mb-8">
              <div className="bg-purple-600 rounded-xl p-4 mr-6">
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <p className="text-lg text-gray-700 leading-relaxed mb-6">
                  The Everyday Workflow SaaS platform is a white-label, fully managed solution powered
                  by Go High Level. It provides a unified system for CRM, pipelines, automations,
                  calendars, communication, and reporting.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed mb-6">
                  Clients don't need to know what GHL is or how it works. Everyday Workflow configures
                  everything, integrates it with your AI agents and automations, maintains the system,
                  and provides ongoing support. You get a simplified, curated experience that just works.
                </p>
              </div>
