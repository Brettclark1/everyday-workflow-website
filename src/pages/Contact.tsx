      ...
      <section className="bg-gradient-to-br from-blue-50 to-white py-16 sm:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 leading-relaxed">
            ...
            schedule a strategy call to discuss your automation needs.
          </p>
        </div>
      </section>
            ...
            <div>
              <div className="bg-white border-2 border-gray-200 rounded-2xl p-8 md:p-10 shadow-lg">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-blue-600 text-white px-8 py-4 rounded-lg hover:bg-blue-700 transition-all transform hover:scale-105 font-semibold text-lg shadow-lg"
                  >
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                  <p className="text-sm text-gray-600 text-center">
                    ...
                    <a href="tel:+14804155274" className="text-blue-600 hover:text-blue-700 font-semibold">
                      (480) 415-5274
                    </a>
                  </p>
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-700">
                ...
                We'll provide a custom quote during your strategy call.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-700">
                ...
                longer, but we'll provide a clear timeline during your strategy call.
              </p>
            </div>
